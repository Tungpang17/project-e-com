...
<h3><img src="img/ru1.png" width="50" height="50">ร้านค้าวิสาหกิจชุมชนบ้านพวนผ้ามัดหมี่</h3>
	<h3>รายงานข้อมูลพนักงาน  <button type="button" class="btn btn-light" onclick="print();" id="hid"> 
...
for(var i=0;i<obj.length; i++){
  ...
  $("#tbody1").html($("#tbody1").html()+'<tr onclick="show_click('+i+')" style="cursor:pointer"><td>'+obj[i].user_id+'</td><td>'+obj[i].user_name+'</td><td>'+obj[i].address+'</td><td>'+obj[i].Fb_line+'</td><td>'+obj[i].phone+'</td></tr>');
}
