...
<a class="btn btn-secondary btn-lg btn-block" href="repost_admin_user.php" role="button">รายงานสิทธิ์การเข้าใช้งาน</a>
...
<a class="btn btn-secondary btn-lg btn-block" href="repost_pro_t.php" role="button">รายงานข้อมูลสินค้าคงคลัง </a>
...
<a class="btn btn-secondary btn-lg btn-block" href="repost_order.php" role="button">รายงานข้อมูลการขายสินค้า  (ตามช่วงเวลาที่กำหนด)</a>
...
<a class="btn btn-secondary btn-lg btn-block" href="repost_income.php" role="button">รายงานข้อมูลรายได้สถานประกอบการ</a>
</div>
</div><br>
<?php
include("foot.php");
