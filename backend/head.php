...
<script src="js/addons/datatables-select2.min.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="/bootstrap-5.0.0-alpha1-dist/css/bootstrap.min.css" integrity="sha384-r4NyP46KrjDleawBgD5tp8Y7UzmLA05oM1iAEQ17CSuDqnUK2+k9luXQOfXJCJ4I" crossorigin="anonymous">
   ...
   <img src="img/ru1.png" width="85" height="85">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
      	<li class="nav-item">
          <center></center>
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='edit_user.php') echo "active";?>" href="edit_user.php">จัดการข้อมูลพนักงาน</a>
        </li>
        <li class="nav-item">
          
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='edit_member.php') echo "active";?>" href="edit_member.php">จัดการข้อมูลสมาชิก</a>
        </li>
    
         <li class="nav-item dropdown">
          
         <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='edit_product.php') echo "active";?>" href="edit_product.php">จัดการข้อมูลสินค้า</a>

          <!-- <a class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-expanded="false">
            จัดการข้อมูลสินค้า
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item <?php if(basename($_SERVER['PHP_SELF'])=='edit_product.php') echo "active";?>" href="edit_product.php">จัดการข้อมูลสินค้า</a></li>
            <li><a class="dropdown-item <?php if(basename($_SERVER['PHP_SELF'])=='edit_stock.php') echo "active";?>" href="edit_stock.php">จัดการหมวดหมู่สินค้า</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='stock.php') echo "active";?>" href="stock.php">จัดการข้อมูลสินค้าคงคลัง</span>
          </a>
        </li>
        <!-- <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='payment.php') echo "active";?>" href="payment.php" aria-current="page">แจ้งชำระเงิน</a>
        </li>
        <li class="nav-item">
          
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='transport.php') echo "active";?>" href="transport.php" aria-current="page">การจัดส่ง</a>
        </li>
         <li class="nav-item">
          
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='repost.php') echo "active";?>" href="repost.php">รายงาน</a>
        </li>  
       </ul>
    </div>
    <div class="btn-group dropleft">
<i class="fa fa-user-circle fa-2x" style="color: #fff;cursor:pointer"  aria-hidden="true" data-toggle="dropdown"></i>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <center><a href="stock.php"><img src="img/11.png" width="50" height="50"></a></center>
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='stock.php') echo "active";?>" href="stock.php">จัดการข้อมูลคลังสินค้า</span>
          </a>
        </li>
        <!-- <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link <?php if(basename($_SERVER['PHP_SELF'])=='search_user.php') echo "active";?>" href="search_user.php">แก้ไขข้อมูลส่วนตัว</a>
        </li>
       </ul>
    </div>
    <div class="btn-group dropleft">
