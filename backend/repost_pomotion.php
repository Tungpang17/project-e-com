...
<h3><img src="img/ru1.png" width="50" height="50">ร้านค้าวิสาหกิจชุมชนบ้านพวนผ้ามัดหมี่</h3>
	<h3>รายงานข้อมูลโปรโมชั่น  <button type="button" class="btn btn-light" onclick="print();" id="hid"> 
...
<table  class="table" cellspacing="0" width="100%">
  <thead>
    <tr>
      ...
      <th scope="col">ช่วงโปรโมชั่น</th>
    </tr>
  </thead>

  <tbody id="tbody1">
    <?php
    $sql="SELECT * FROM `product` WHERE 1 AND `pro`=1";

    if($_GET["date_s"] !="" && $_GET["date_e"] !=""){
        $sql.=" AND (pro_s>='".$_GET["date_s"]."' AND pro_e<='".$_GET["date_e"]."')";    
    }
...
?>
      ...
      <td><?php echo $re["pro_s"];?> ถึง <?php echo $re["pro_e"];?></td>
    </tr>
