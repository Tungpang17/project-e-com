      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav1">
          ...
          <form class="form-inline waves-effect waves-light">
            <input class="form-control" type="search" placeholder="ค้นหาสินค้า" name="search"
              value="<?php echo $_GET["search"]; ?>">
          </form>&nbsp;
          <a href="taka.php"><button type="button" class="btn btn-warning"><i class="fas fa-shopping-basket">ตะกร้า</i>
            </button></a>
        </div>
      </div>
    </nav>
          ...
          <div class="widget-wrapper">
            ...
            <div class="list-group">
              ...
              while ($re = mysqli_fetch_assoc($que)) {
                ?>
                <a href="index.php?type_id=<?php echo $re["type_id"]; ?>"
                  class="list-group-item "><?php echo $re["type_name"]; ?></a>
              <?php } ?>
            </div>
          </div>
        ...
        <?php } else { ?>
          <div class="widget-wrapper wow fadeIn" data-wow-delay="0.4s">
            ...
            <form id="form1">
              ...
              <a href="order-history.php"><button type="button" class="btn btn-secondary">ประวัติการสั่งซื้อ</button></a>
