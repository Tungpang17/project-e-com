...
<?php echo $re["tra_track"].'<br><a href="https://ems.thaiware.com/'.$re["tra_track"].'" target="_blank"><span class="badge badge-secondary">ตรวจสอบ</span></a>';?>
      ...
      <td><?php if($re["pay_status"]==1 && $re["tra_track"]!="" && $re["tra_status"]!=1){?>
        <a href="update_transport.php?tra_id=<?php echo $re["tra_id"];?>"><button type="button" class="btn btn-primary">หากได้รับสินค้าแล้ว โปรดคลิก</button></a>
      <?php }?>
      </td>
      <td>
...
?>
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted"> จำนวน <?php echo $re2["pro_amount"];?> ชิ้น </small></p>
