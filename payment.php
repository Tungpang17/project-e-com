...
<style>
  ...
  <h4 class="alert-heading">การสั่งซื้อเลขที่ #<?php echo $_GET["order_id"];?></h4>
  <!-- <p>รายการ</p>
  <p></p> -->
  <hr>
  <p class="mb-0">จำนวนเงินทั้งหมด <?php echo number_format($re["order_tatal"]+50,2);?> บาท (รวมส่ง)</p>
</div>
<img src="backend/img/bank1.jpg" class="img-fluid" alt="">
<hr>
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="pay_address" name="pay_address" rows="3"><?php echo  
              $_SESSION["otop"]["address"]; ?></textarea>
            </div>
