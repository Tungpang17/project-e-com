...
if (!empty($start_date) && !empty($end_date)) {
    $condition = "WHERE tra_date BETWEEN '$start_date' AND '$end_date'";
} elseif (!empty($start_date)) {
    $condition = "WHERE tra_date >= '$start_date'";
} elseif (!empty($end_date)) {
    $condition = "WHERE tra_date <= '$end_date'";
}
?>
<!DOCTYPE html>
<html lang="th">
...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3>รายงานข้อมูลการจัดส่งสินค้า</h3>
        ...
        <form method="GET" action="">
            <div class="row mb-3">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="repost_transport.php" class="btn btn-secondary ms-2">ล้างค่า</a>
                </div>
            </div>
        </form>
        ...
        <table id="memberTable" class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $sql = "SELECT * FROM `transport` $condition";
                ...
                ?>
                    <tr>
                        ...
                        <td><?php if($re["tra_status"] == 1) {echo "จัดส่งสำเร็จ";}else{echo "กำลังดำเนินการจัดส่ง";} ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#memberTable').DataTable({
             ...
             var categoryFilter = $('<div class="category-filter"><label for="categoryFilter">เลือกสถานะ:</label><select id="categoryFilter" class="form-select"><option value="">ทั้งหมด</option><option value="จัดส่งสำเร็จ">จัดส่งสำเร็จ</option><option value="กำลังดำเนินการจัดส่ง">กำลังดำเนินการจัดส่ง</option></select></div>');
