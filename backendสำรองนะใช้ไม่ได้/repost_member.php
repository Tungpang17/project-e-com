...
if (!empty($start_date) && !empty($end_date)) {
    $condition = "WHERE m_datetime BETWEEN '$start_date' AND '$end_date'";
} elseif (!empty($start_date)) {
    $condition = "WHERE m_datetime >= '$start_date'";
} elseif (!empty($end_date)) {
    $condition = "WHERE m_datetime <= '$end_date'";
}
?>
<!DOCTYPE html>
<html lang="th">
        ...
        <form method="GET" action="">
            <div class="row mb-3">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <a href="repost_member.php" class="btn btn-secondary ms-2">ล้างค่า</a>
                </div>
            </div>
        </form>
